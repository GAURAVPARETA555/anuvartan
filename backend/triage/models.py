...
class Case(models.Model):
    ...
    ai_summary=models.JSONField(blank=True, null=True)  # Stores structured triage data from AI tool-call (chief_complaint, symptoms, severity, etc.)
    ...
    ai_explanation=models.JSONField(blank=True, null=True)
